...
export function buildWorkerTaskPrompt(
	...
	lines.push(
		...
		"## Instructions",
		"",
		"1. Perform a " + scope + " review of the Source files for this chapter, developing a deep understanding of the code",
		"2. Review the Chapter components to update",
		"3. Now, expand on the files in (2) based on the " + scope + " review in (1) - the target audience is [" + audience + "]",
		"",
