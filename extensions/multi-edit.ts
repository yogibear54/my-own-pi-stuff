...
const editItemSchema = Type.Object({
	path: Type.String({ description: "Path to the file to edit (relative or absolute). Inherits from top-level path if omitted." }),
...
const multiEditSchema = Type.Object({
	...
	multi: Type.Optional(
		Type.Array(editItemSchema, {
			description: "Multiple edits to apply in sequence. Each item must have path, oldText, and newText.",
		}),
	),
	patch: Type.Optional(
		Type.String({
